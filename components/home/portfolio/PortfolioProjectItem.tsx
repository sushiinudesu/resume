...
export default function PortfolioProjectItem({
  ...
  return (
    <li key={project.id}>
      ...
      <div className="mx-auto lg:mx-0 lg:ml-8 max-w-3xl rounded-lg max-2xs:rounded-none border border-zinc-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-900/70 p-4">
